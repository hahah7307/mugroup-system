<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:94:"/Users/hahah./Documents/wwwroot/hardware-tools/public/../application/Manage/view/param/web.php";i:1603419599;s:88:"/Users/hahah./Documents/wwwroot/hardware-tools/application/Manage/view/public/header.php";i:1606889687;s:86:"/Users/hahah./Documents/wwwroot/hardware-tools/application/Manage/view/public/left.php";i:1607326502;s:88:"/Users/hahah./Documents/wwwroot/hardware-tools/application/Manage/view/public/footer.php";i:1599103444;}*/ ?>
		...
		<div class="layui-form">
			<div class="layui-form-item">
				...
				<div class="layui-input-inline w300">
					<input type="text" class="layui-input" name="aboutProduct" value="<?php echo $info['aboutProduct']; ?>" placeholder="请填写相关产品数">
				</div>
			</div>
			<div class="layui-form-item">
				<label class="layui-form-label">推荐产品数</label>
				<div class="layui-input-inline w300">
					<input type="text" class="layui-input" name="hotProduct" value="<?php echo $info['hotProduct']; ?>" placeholder="请填写推荐产品数">
				</div>
			</div>
			<div class="layui-form-item">
				<label class="layui-form-label">首页产品数</label>
				<div class="layui-input-inline w300">
					<input type="text" class="layui-input" name="indexProduct" value="<?php echo $info['indexProduct']; ?>" placeholder="请填写产品列表数">
				</div>
			</div>
			<div class="layui-form-item">
				<label class="layui-form-label">最新产品数</label>
				<div class="layui-input-inline w300">
					<input type="text" class="layui-input" name="lastProduct" value="<?php echo $info['lastProduct']; ?>" placeholder="请填写最新产品数">
				</div>
			</div>
			<div class="layui-form-item">
				<label class="layui-form-label">产品列表数</label>
				<div class="layui-input-inline w300">
					<input type="text" class="layui-input" name="listProduct" value="<?php echo $info['listProduct']; ?>" placeholder="请填写产品列表数">
				</div>
			</div>
			<div class="layui-form-item">
				<label class="layui-form-label">文章列表数</label>
				<div class="layui-input-inline w300">
					<input type="text" class="layui-input" name="listNews" value="<?php echo $info['listNews']; ?>" placeholder="请填写文章列表数">
				</div>
			</div>
			<div class="layui-form-item">
				<label class="layui-form-label">最新文章数</label>
				<div class="layui-input-inline w300">
					<input type="text" class="layui-input" name="lastArticle" value="<?php echo $info['lastArticle']; ?>" placeholder="请填写最新文章数">
				</div>
			</div>
			<div class="layui-form-item">
				<label class="layui-form-label">最近单页数</label>
				<div class="layui-input-inline w300">
					<input type="text" class="layui-input" name="lastPage" value="<?php echo $info['lastPage']; ?>" placeholder="请填写最近单页数">
				</div>
			</div>
			<div class="layui-form-item">
				<label class="layui-form-label">下载列表数</label>
				<div class="layui-input-inline w300">
					<input type="text" class="layui-input" name="listDown" value="<?php echo $info['listDown']; ?>" placeholder="请填写下载列表数">
				</div>
			</div>
			<div class="layui-form-item">
...
layui.use(['form', 'jquery'], function(){
	...
	form.on('submit(formCoding)', function(data){
		...
		button.text('请稍候...');
		$.ajax({
			type:'POST',url:"<?php echo url('web'); ?>",data:data.field,dataType:'json',
			success:function(data){
				if(data.code == 1){
