<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:105:"/Users/hahah./Documents/wwwroot/hardware-tools/public/../application/Home/view/default/member/feature.php";i:1610070103;s:94:"/Users/hahah./Documents/wwwroot/hardware-tools/application/Home/view/default/public/header.php";i:1607996284;s:94:"/Users/hahah./Documents/wwwroot/hardware-tools/application/Home/view/default/public/footer.php";i:1607561991;}*/ ?>
...
<section class="ynq-HeaderBanner">
	<div width="1200px" class="ynq-HeaderBanner-text">
		...
		<a href="<?php echo jump('Member/page'); ?>">会员服务</a><span>/</span>
		<a href="<?php echo jump('Member/feature'); ?>">会员风采</a></p>
	</div>
</section>
<!--新闻中心-->
<section class="ynq-block-sub">
	<div width="1200px" class="ynq-news-block">
		<ul class="ynq-subpage-menu" flex="">
			<li <?php if($slug == 'page'): ?>class="subpage-menu-active"<?php endif; ?>><a href="<?php echo jump('Member/page'); ?>"><?php if($slug == 'page'): ?><cite class="fa fa-check-circle"></cite><?php else: ?><cite class="fa fa-circle-o"></cite><?php endif; ?>入会申请</a></li>
			<li <?php if($slug == 'feature'): ?>class="subpage-menu-active"<?php endif; ?>><a href="<?php echo jump('Member/feature'); ?>"><?php if($slug == 'feature'): ?><cite class="fa fa-check-circle"></cite><?php else: ?><cite class="fa fa-circle-o"></cite><?php endif; ?>会员风采</a></li>
		</ul>
		
		<div class="ynq-content">
			<ul class="ynq-member-fencai">
				<?php if(is_array($rank) || $rank instanceof \think\Collection || $rank instanceof \think\Paginator): if( count($rank)==0 ) : echo "" ;else: foreach($rank as $key=>$ran): ?>
				<li><?php echo $ran['name']; ?></li>
				<span>以下排序不分先后顺序</span>
				<?php if($ran['relations'] != null): ?>
				<ul flex="" class="ynq-member-company">
					<?php if(is_array($ran['relations']) || $ran['relations'] instanceof \think\Collection || $ran['relations'] instanceof \think\Paginator): if( count($ran['relations'])==0 ) : echo "" ;else: foreach($ran['relations'] as $key=>$mem): ?>
					<li><a href="<?php echo jump('Member/detail', ['slug' => $mem['member']['slug']]); ?>"><?php echo $mem['member']['company_name']; ?></a></li>
					<?php endforeach; endif; else: echo "" ;endif; ?>
				</ul>
				<?php endif; endforeach; endif; else: echo "" ;endif; ?>
			</ul>
			<!-- <div class="ynq-member-table"><a href="<?php echo $file['url']; ?>" target="_blank" radius="3"><cite class="fa fa-bars"></cite>会员单位名单列表</a></div> -->
		</div>
