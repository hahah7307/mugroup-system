<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:96:"/Users/hahah./Documents/wwwroot/hardware-tools/public/../application/manage/view/image/index.php";i:1607935033;s:88:"/Users/hahah./Documents/wwwroot/hardware-tools/application/manage/view/public/header.php";i:1606889687;s:86:"/Users/hahah./Documents/wwwroot/hardware-tools/application/manage/view/public/left.php";i:1607326502;s:88:"/Users/hahah./Documents/wwwroot/hardware-tools/application/manage/view/public/footer.php";i:1599103444;}*/ ?>
    ...
    <div class="right">
		...
		<form class="layui-form search-form" method="get">
			...
			<div class="layui-inline">
				<input type="text" class="layui-input" name="keyword" value="<?php echo $keyword; ?>" placeholder="搜索图片名称">
			</div>
			<div class="layui-inline">
                	...
                	<?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): if( count($list)==0 ) : echo "" ;else: foreach($list as $key=>$v): ?>
                   	<li>
                        <div class="YanNanQiu_img">
                            <img src="<?php echo imageurl_to_path($v['url']); ?>">
                        </div>
                        <a href="javascript:;" class="YanNanQiu_imgViews" data-url="<?php echo imageurl_to_path($v['url']); ?>"><cite class="layui-icon layui-icon-picture"></cite></a>
                        <a href="javascript:;" class="YanNanQiu_imgEdits" data-url="<?php echo imageurl_to_path($v['url']); ?>" data-id="<?php echo $v['id']; ?>"><cite class="layui-icon layui-icon-edit"></cite></a>
                        <div class="YanNanQiu_Checkbox">
                            <input type="checkbox" name="img[]" lay-skin="primary" lay-filter="imgbox" class="YanNanQiu_imgId" value="<?php echo $v['id']; ?>">
                        </div>
                        <div class="YanNanQiu_ImgTitle"><?php echo $v['title']; ?></div>
                    </li>
                    <?php endforeach; endif; else: echo "" ;endif; ?>
                </ul>
            </div>
