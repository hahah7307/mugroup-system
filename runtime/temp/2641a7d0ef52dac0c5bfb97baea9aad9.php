<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:92:"/Users/hahah./Documents/wwwroot/hardware-tools/public/../application/manage/view/seo/tkd.php";i:1606889850;s:88:"/Users/hahah./Documents/wwwroot/hardware-tools/application/manage/view/public/header.php";i:1606889687;s:86:"/Users/hahah./Documents/wwwroot/hardware-tools/application/manage/view/public/left.php";i:1607326502;s:88:"/Users/hahah./Documents/wwwroot/hardware-tools/application/manage/view/public/footer.php";i:1599103444;}*/ ?>
...
<div class="layui-body" id="LAY_app_body">
    <div class="right">
		...
		<div class="layui-form">
			<?php if(is_array($btn) || $btn instanceof \think\Collection || $btn instanceof \think\Paginator): if( count($btn)==0 ) : echo "" ;else: foreach($btn as $k=>$b): ?>
			<a class='layui-btn <?php if($model == $k): ?>layui-btn-warm<?php endif; ?>' href="<?php echo url('Seo/tkd', ['model' => $k]); ?>"><?php echo $b; ?></a>
			<?php endforeach; endif; else: echo "" ;endif; ?>
			<table class="layui-table">
				...
				<tbody>
					<?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): if( count($list)==0 ) : echo "" ;else: foreach($list as $key=>$v): ?>
						<tr>
							<td>
								<?php if(($model == 'PageModel') or ($model == 'ArticleModel')): ?>
									<?php echo $v['title']; else: ?>
									<?php echo $v['name']; endif; ?>
							</td>
							<td class="tc">
								<div class="layui-input-inline w200">
									<input type="hidden" name="seo_id[]" value="<?php echo $v['id']; ?>">
									<input type="text" class="layui-input" name="seo_title[]" value="<?php echo $v['seo_title']; ?>">
								</div>
							</td>
							<td class="tc">
								<div class="layui-input-inline w200">
									<input type="text" class="layui-input" name="seo_keyword[]" value="<?php echo $v['seo_keyword']; ?>">
								</div>
							</td>
							<td class="tc">
								<div class="layui-input-inline w200">
									<textarea name="seo_description[]" class="layui-textarea mh40"><?php echo $v['seo_description']; ?></textarea>
								</div>
							</td>
							<td class="tc">
								<button class="layui-btn layui-btn-normal layui-btn-sm"  data-id="<?php echo $v['id']; ?>" lay-submit lay-filter="formCoding">编辑</button>
							</td>
						</tr>
					<?php endforeach; endif; else: echo "" ;endif; ?>
				</tbody>
...
layui.use(['form', 'jquery'], function(){
	...
	form.on('submit(formCoding)', function(data) {
		var text = $(this).text(),
			...
			data.field.model = "<?php echo $model; ?>";
		button.text('请稍候...');
		$.ajax({
			type:'POST',url:"<?php echo url('tkd_edit'); ?>",data:data.field,dataType:'json',
			success:function(data){
				if(data.code == 1){
