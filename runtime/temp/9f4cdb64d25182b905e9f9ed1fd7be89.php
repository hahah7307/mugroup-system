<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:104:"/Users/hahah./Documents/wwwroot/hardware-tools/public/../application/Manage/view/app_template/manage.php";i:1600762413;s:88:"/Users/hahah./Documents/wwwroot/hardware-tools/application/Manage/view/public/header.php";i:1606889687;s:86:"/Users/hahah./Documents/wwwroot/hardware-tools/application/Manage/view/public/left.php";i:1607326502;s:88:"/Users/hahah./Documents/wwwroot/hardware-tools/application/Manage/view/public/footer.php";i:1599103444;}*/ ?>
			...
			<table class="layui-table">
				...
				<tbody>
					<?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): if( count($list)==0 ) : echo "" ;else: foreach($list as $key=>$v): ?>
						<tr>
							<td><img src="<?php echo imageurl_to_path($v['pic']); ?>" height="80"></td>
							...
							<td class="tc">
								...
								<?php else: ?>
									<button data-id="<?php echo $v['id']; ?>" class="layui-btn layui-btn-sm layui-btn-normal" lay-submit lay-filter="Default">设为默认</button>
									<button data-id="<?php echo $v['id']; ?>" class="layui-btn layui-btn-sm layui-btn-danger ml0" lay-submit lay-filter="Detele">删除</button>
								<?php endif; ?>
							</td>
						</tr>
...
layui.use(['form', 'jquery'], function(){
	...
	form.on('submit(Default)', function(data){
		...
		layer.confirm('确定设为默认模板吗？',{icon:3,closeBtn:0,title:false,btnAlign:'c'},function(){
			...
			button.text('请稍候...');
			$.ajax({
				type:'POST',url:"<?php echo url('set_default'); ?>",data:{id:id},dataType:'json',
				success:function(data){
					if(data.code == 1){
