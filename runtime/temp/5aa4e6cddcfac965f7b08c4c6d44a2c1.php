<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:96:"/Users/hahah./Documents/wwwroot/hardware-tools/public/../application/Manage/view/admin/index.php";i:1601347063;s:88:"/Users/hahah./Documents/wwwroot/hardware-tools/application/Manage/view/public/header.php";i:1606889687;s:86:"/Users/hahah./Documents/wwwroot/hardware-tools/application/Manage/view/public/left.php";i:1607326502;s:88:"/Users/hahah./Documents/wwwroot/hardware-tools/application/Manage/view/public/footer.php";i:1599103444;}*/ ?>
    ...
    <div class="right">
        ...
        <form class="layui-form search-form" method="get">
			<div class="layui-inline w200">
				<input type="text" class="layui-input" name="keyword" value="<?php echo $keyword; ?>" placeholder="用户名、昵称、手机号或邮箱">
			</div>
		...
		<div class="layui-form">
			<a class="layui-btn" href="<?php echo url('user_add'); ?>">添加</a>
				...
				<tbody>
					<?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): if( count($list)==0 ) : echo "" ;else: foreach($list as $key=>$v): ?>
						<tr>
							...
							<td class="tc">
								<a href="<?php echo url('user_login', ['id' => $v['id']]); ?>" class="layui-btn layui-btn-sm">登录</a>
								<a href="<?php echo url('user_edit', ['id' => $v['id']]); ?>" class="layui-btn layui-btn-normal layui-btn-sm">编辑</a>
...
layui.use(['form', 'jquery'], function(){
	...
	form.on('switch(formLock)', function(data){
		...
		$.ajax({
			type:'POST',url:"<?php echo url('user_status'); ?>",data:{id:data.value,type:'look'},dataType:'json',
			success:function(data){
				if(data.code == 0){
	...
	form.on('submit(Detele)', function(data){
		...
		layer.confirm('确定删除吗？',{icon:3,closeBtn:0,title:false,btnAlign:'c'},function(){
			...
			button.text('请稍候...');
			$.ajax({
				type:'POST',url:"<?php echo url('user_delete'); ?>",data:{id:id},dataType:'json',
				success:function(data){
					if(data.code == 1){
