<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:82:"D:\phpstudy_pro\WWW\hardware-tools\public/../application/manage\view\page\edit.php";i:1607915152;s:76:"D:\phpstudy_pro\WWW\hardware-tools\application\Manage\view\public\header.php";i:1606889687;s:74:"D:\phpstudy_pro\WWW\hardware-tools\application\Manage\view\public\left.php";i:1607326502;s:76:"D:\phpstudy_pro\WWW\hardware-tools\application\Manage\view\public\footer.php";i:1599103444;}*/ ?>
    ...
    <div class="right">
		...
		<div class="layui-form">
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-block w300">
					<select name="template_file" lay-verify="required">
						<option value="detail" <?php if($info['template_file'] == 'detail'): ?>selected<?php endif; ?>>默认模板</option>
						<option value="detail_about" <?php if($info['template_file'] == 'detail_about'): ?>selected<?php endif; ?>>关于我们</option>
						<option value="detail_contact" <?php if($info['template_file'] == 'detail_contact'): ?>selected<?php endif; ?>>联系我们</option>
					</select>
				</div>
			</div>
			<div class="layui-form-item">
				...
				<div class="layui-input-inline w800">
					<textarea name="brief" placeholder="" class="layui-textarea"><?php echo $info['brief']; ?></textarea>
				</div>
			</div>
