...
<section class="ynq-block-sub">
	<div width="1200px" class="ynq-news-block">
		<ul class="ynq-subpage-menu" flex="">
			<li <?php if($info['slug'] == 'commerce-news'): ?>class="subpage-menu-active"<?php endif; ?>><a href="<?php echo jump('Article/index', ['slug' => 'commerce-news']); ?>"><?php if($info['slug'] == 'commerce-news'): ?><cite class="fa fa-check-circle"></cite><?php else: ?><cite class="fa fa-circle-o"></cite><?php endif; ?>商会新闻</a></li>
			<li <?php if($info['slug'] == 'live-news'): ?>class="subpage-menu-active"<?php endif; ?>><a href="<?php echo jump('Article/index', ['slug' => 'live-news']); ?>"><?php if($info['slug'] == 'live-news'): ?><cite class="fa fa-check-circle"></cite><?php else: ?><cite class="fa fa-circle-o"></cite><?php endif; ?>商会风采</a></li>
			<li <?php if($info['slug'] == 'member-news'): ?>class="subpage-menu-active"<?php endif; ?>><a href="<?php echo jump('Article/index', ['slug' => 'member-news']); ?>"><?php if($info['slug'] == 'member-news'): ?><cite class="fa fa-check-circle"></cite><?php else: ?><cite class="fa fa-circle-o"></cite><?php endif; ?>会员动态</a></li>
		</ul>
		
		<ul class="ynq-subnew-list">
			<?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): if( count($list)==0 ) : echo "" ;else: foreach($list as $key=>$v): ?>
			<li>
				<a href="<?php echo jump('Article/detail', ['slug' => $v['slug']]); ?>">
					<div class="ynq-newssub-img"><img src="<?php echo imageurl_to_path($v['thumb']); ?>" alt=""></div>
				</a>
				<div class="ynq-subnew-text">
					<h1><a href="<?php echo jump('Article/detail', ['slug' => $v['slug']]); ?>"><?php echo $v['title']; ?></a><span><?php echo date("Y-m-d", $v['created_at']); ?></span></h1>
					<p data-row="4"><?php echo $v['summary']; ?></p>
				</div>
			</li>
			<?php endforeach; endif; else: echo "" ;endif; ?>
		</ul>
