<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:100:"/Users/hahah./Documents/wwwroot/hardware-tools/public/../application/Manage/view/site/web_params.php";i:1606201118;s:88:"/Users/hahah./Documents/wwwroot/hardware-tools/application/Manage/view/public/header.php";i:1606889687;s:86:"/Users/hahah./Documents/wwwroot/hardware-tools/application/Manage/view/public/left.php";i:1607326502;s:88:"/Users/hahah./Documents/wwwroot/hardware-tools/application/Manage/view/public/footer.php";i:1599103444;}*/ ?>
    ...
    <div class="right">
		...
		<div class="layui-form">
			<div class="layui-form-item">
				...
				<div class="layui-input-inline w300">
					...
					<span class="input-group-btn">
						...
						<?php if($info['logo'] != null): ?>
							<li style="margin: 2px">
								<img src="/upload/<?php echo $info['logo']; ?>">
								<span>
				...
				<div class="layui-input-inline w300">
					...
					<span class="input-group-btn">
						...
						<ul class="YanNanQiu-upload-list">
						<?php if($info['qrcode'] != null): ?>
							<li style="margin: 2px">
								<img src="/upload/<?php echo $info['qrcode']; ?>">
								<span>
									<i class="fa fa-times"></i>
								</span>
								<input type="hidden" name="qrcode[]" value="<?php echo $info['qrcode']; ?>">
							</li>
						<?php endif; ?>
						</ul>
					</span>
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline w300">
					<input type="text" class="layui-input" name="web_title" value="<?php echo $info['web_title']; ?>" placeholder="请填写网站名称">
				</div>
				<label class="layui-form-label">公司名称</label>
				<div class="layui-input-inline w300">
					<input type="text" class="layui-input" name="corporate_name" value="<?php echo $info['corporate_name']; ?>" placeholder="请填写公司名称">
				</div>
			</div>
			<div class="layui-form-item">
				<label class="layui-form-label">备案号</label>
				<div class="layui-input-inline w300">
					<input type="text" class="layui-input" name="icp" value="<?php echo $info['icp']; ?>" placeholder="请填写备案号">
				</div>
				<label class="layui-form-label">版权信息</label>
				<div class="layui-input-inline w300">
					<input type="text" class="layui-input" name="copyrights" value="<?php echo $info['copyrights']; ?>" placeholder="请填写版权信息">
				</div>
			</div>
			<div class="layui-form-item">
				<label class="layui-form-label">邮箱</label>
				<div class="layui-input-inline w300">
					<input type="text" class="layui-input" name="email" value="<?php echo $info['email']; ?>" placeholder="请填写邮箱">
				</div>
				<label class="layui-form-label">电话</label>
				<div class="layui-input-inline w300">
					<input type="text" class="layui-input" name="telephone" value="<?php echo $info['telephone']; ?>" placeholder="请填写电话">
				</div>
			</div>
			<div class="layui-form-item">
				<label class="layui-form-label">传真</label>
				<div class="layui-input-inline w300">
					<input type="text" class="layui-input" name="fax" value="<?php echo $info['fax']; ?>" placeholder="请填写传真">
				</div>
			</div>
			<div class="layui-form-item">
				<label class="layui-form-label">地址</label>
				<div class="layui-input-block">
					<input type="text" class="layui-input" name="address" value="<?php echo $info['address']; ?>" placeholder="请填写地址">
				</div>
			</div>
			<div class="layui-form-item layui-form-text">
				<label class="layui-form-label">SEO标题</label>
				<div class="layui-input-block">
					<input type="text" class="layui-input" name="seo_title" value="<?php echo $info['seo_title']; ?>" placeholder="请填写SEO标题">
				</div>
			</div>
			<div class="layui-form-item layui-form-text">
				<label class="layui-form-label">SEO关键词</label>
				<div class="layui-input-block">
					<input type="text" class="layui-input" name="seo_keyword" value="<?php echo $info['seo_keyword']; ?>" placeholder="请填写SEO关键词">
				</div>
			</div>
			<div class="layui-form-item layui-form-text">
				<label class="layui-form-label">SEO描述</label>
				<div class="layui-input-block">
					<textarea class="layui-textarea" name="seo_description" placeholder="请填写SEO描述"><?php echo $info['seo_description']; ?></textarea>
				</div>
			</div>
			<div class="layui-form-item layui-form-text">
				<label class="layui-form-label">统计代码</label>
				<div class="layui-input-block">
					<textarea class="layui-textarea" name="third_code_footer" placeholder="请填写统计代码"><?php echo $info['third_code_footer']; ?></textarea>
				</div>
			</div>
			<div class="layui-form-item">
				<div class="layui-input-block">
...
layui.use(['form', 'jquery'], function(){
	...
	form.on('submit(formCoding)', function(data){
		...
		button.text('请稍候...');
		$.ajax({
			type:'POST',url:"<?php echo url('web_params'); ?>",data:data.field,dataType:'json',
			success:function(data){
				if(data.code == 1){
