<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:95:"/Users/hahah./Documents/wwwroot/hardware-tools/public/../application/Manage/view/page/index.php";i:1600843613;s:88:"/Users/hahah./Documents/wwwroot/hardware-tools/application/Manage/view/public/header.php";i:1606889687;s:86:"/Users/hahah./Documents/wwwroot/hardware-tools/application/Manage/view/public/left.php";i:1607326502;s:88:"/Users/hahah./Documents/wwwroot/hardware-tools/application/Manage/view/public/footer.php";i:1599103444;}*/ ?>
        ...
        <form class="layui-form search-form" method="get">
			...
			<div class="layui-inline w150">
				<select name="cid">
					...
					<?php if(is_array($category) || $category instanceof \think\Collection || $category instanceof \think\Paginator): if( count($category)==0 ) : echo "" ;else: foreach($category as $key=>$cate): ?>
						<option value="<?php echo $cate['id']; ?>" <?php if($cid == $cate['id']): ?>selected<?php endif; ?>><?php echo $cate['name']; ?></option>
					<?php endforeach; endif; else: echo "" ;endif; ?>
				</select>
			</div>
				...
				<tbody>
					<?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): if( count($list)==0 ) : echo "" ;else: foreach($list as $key=>$v): ?>
						<tr>
							...
							<td class="tc"><?php echo $v['category']['name']; ?></td>
							<td class="tc">
							...
							<td class="tc"><?php echo date("Y-m-d H:i:s", $v['updated_at']); ?></td>
							<td class="tc">
