...
<section class="ynq-block-sub">
	<div width="1200px" class="ynq-news-block">
		...
		<div class="ynq-content">
			<div class="ynq-membertitle" style="font-size:20px;">
				<?php if(is_array($member['member_relation']) || $member['member_relation'] instanceof \think\Collection || $member['member_relation'] instanceof \think\Paginator): if( count($member['member_relation'])==0 ) : echo "" ;else: foreach($member['member_relation'] as $key=>$v): if($key != 0): ?>
				，<?php echo $v['rank']['name']; else: ?>
				<?php echo $v['rank']['name']; endif; endforeach; endif; else: echo "" ;endif; ?>
			</div>	
			<h4><?php echo $member['company_name']; ?></h4>
			<div class="ynq-memberShowCont">
				<?php echo $member['feature']; ?>
			</div>
		</div>
	</div>
</section>
