<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:81:"D:\phpstudy_pro\WWW\hardware-tools\public/../application/manage\view\page\add.php";i:1607915142;s:76:"D:\phpstudy_pro\WWW\hardware-tools\application\Manage\view\public\header.php";i:1606889687;s:74:"D:\phpstudy_pro\WWW\hardware-tools\application\Manage\view\public\left.php";i:1607326502;s:76:"D:\phpstudy_pro\WWW\hardware-tools\application\Manage\view\public\footer.php";i:1599103444;}*/ ?>
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-block w300">
					<select name="template_file" lay-verify="required">
						<option value="detail">默认模板</option>
						<option value="detail_about">关于我们</option>
						<option value="detail_contact">联系我们</option>
					</select>
				</div>
			</div>
			<div class="layui-form-item">
				...
				<div class="layui-input-inline w800">
					<textarea name="brief" placeholder="" class="layui-textarea"></textarea>
				</div>
			</div>
