...
<div class="layui-body" id="LAY_app_body">
    <div class="right">
		...
		<form class="layui-form search-form" method="get">
			...
			<div class="layui-inline">
				<a class="layui-btn layui-btn-normal" href="<?php echo url('source'); ?>"><i class="layui-icon">&#xe621;</i> 重置</a>
			</div>
		</form>
		...
		<div class="visit-body">
			<div class="visit-bing-left">
				<table class="layui-table" lay-even lay-skin="nob">
					...
					<thead>
						<tr>
							<th>来源网址</th>
							<th class="tr"><a href="<?php echo url('source_more',['start' => $start, 'end' => $end]); ?>">查看更多>></a></h3></th>
						</tr> 
					</thead>
					<tbody>
						<?php if(is_array($query) || $query instanceof \think\Collection || $query instanceof \think\Paginator): if( count($query)==0 ) : echo "" ;else: foreach($query as $key=>$web): ?>
						<tr>
							<td><span class="span-left"><?php echo $web['referrer']; ?></span></td>
							<td class="tr"><span class="span-right"><?php echo $web['rsum']; ?></span></td>
						</tr>
						<?php endforeach; endif; else: echo "" ;endif; ?>
					</tbody>
				</table>
			...
			<div class="visit-bing-right">
				...
				<div class="terminal-block-pc">
					...
					<span class="terminal-num"><?php echo $max_width; ?>%</span>
				</div>
				<div class="terminal-block-mobile">
					<span><img src="/static/images/icon-source-mobile.png"></span>
					<span class="terminal-num"><?php echo $min_width; ?>%</span>
				</div>
			</div>
