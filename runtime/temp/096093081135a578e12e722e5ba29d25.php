<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:102:"/Users/hahah./Documents/wwwroot/hardware-tools/public/../application/Manage/view/block_child/index.php";i:1600762472;s:88:"/Users/hahah./Documents/wwwroot/hardware-tools/application/Manage/view/public/header.php";i:1606889687;s:86:"/Users/hahah./Documents/wwwroot/hardware-tools/application/Manage/view/public/left.php";i:1607326502;s:88:"/Users/hahah./Documents/wwwroot/hardware-tools/application/Manage/view/public/footer.php";i:1599103444;}*/ ?>
        ...
        <form class="layui-form search-form" method="get">
			...
			<div class="layui-inline w150">
				<select name="cid">
					...
					<?php if(is_array($group) || $group instanceof \think\Collection || $group instanceof \think\Paginator): if( count($group)==0 ) : echo "" ;else: foreach($group as $k=>$cate): ?>
					<optgroup label="<?php echo index_to_title($k); ?>">
						<?php if(is_array($cate) || $cate instanceof \think\Collection || $cate instanceof \think\Paginator): if( count($cate)==0 ) : echo "" ;else: foreach($cate as $key=>$ca): ?>
						<option value="<?php echo $ca['id']; ?>" <?php if($cid == $ca['id']): ?>selected<?php endif; ?>><?php echo $ca['title']; ?></option>
						<?php endforeach; endif; else: echo "" ;endif; ?>
					</optgroup>
					<?php endforeach; endif; else: echo "" ;endif; ?>
				</select>
			...
			<div class="layui-inline w200">
				<input type="text" class="layui-input" name="keyword" value="<?php echo $keyword; ?>" placeholder="搜索标题">
			</div>
			...
			<table class="layui-table">
				...
				<tbody>
					<?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): if( count($list)==0 ) : echo "" ;else: foreach($list as $key=>$v): ?>
						<tr>
							<td><a href="<?php echo imageurl_to_path($v['pictures']); ?>" target="_blank"><img src="<?php echo imageurl_to_path($v['pictures']); ?>" height="40"></a></td>
							<td><?php echo $v['title']; ?></td>
							<td><?php echo $v['url']; ?></td>
							<td class="tc"><?php echo $v['block']['title']; ?></td>
							<td class="tc">
								<input type="text" class="layui-input w50 h30" name="sort[<?php echo $v['id']; ?>]" value="<?php echo $v['sort']; ?>" placeholder="排序">
							</td>
							<td class="tc">
