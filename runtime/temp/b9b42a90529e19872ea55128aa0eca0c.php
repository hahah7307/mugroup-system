<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:96:"/Users/hahah./Documents/wwwroot/hardware-tools/public/../application/Manage/view/login/index.php";i:1605857438;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
        ...
        <div class="layadmin-user-login-main">
            ...
            <div class="layadmin-user-login-box layadmin-user-login-body layui-form">
                ...
                <div class="layui-form-item" style="margin-bottom: 20px;">
                    ...
                    <a href="<?php echo url('Login/forget'); ?>" class="layadmin-user-jump-change layadmin-link" style="margin-top: 7px;">忘记密码？</a>
                </div>
                <div class="layui-form-item">
