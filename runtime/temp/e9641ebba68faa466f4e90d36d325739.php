...
<div class="layui-body" id="LAY_app_body">
    <div class="right">
		...
		<form class="layui-form search-form" method="get">
			...
			<div class="layui-inline">
				<a class="layui-btn layui-btn-normal" href="<?php echo url('area'); ?>"><i class="layui-icon">&#xe621;</i> 重置</a>
			</div>
		</form>
		...
		<div class="visit-block-left fl">
			<table class="layui-table" lay-even lay-skin="nob">
				...
				<thead>
					<tr>
						<th>来源国家</th>
						<th class="tr view-more"><a href="<?php echo url('area_more',['start' => $start, 'end' => $end]); ?>">查看更多>></a></h3></th>
					</tr> 
				</thead>
				<tbody>
					<?php if(is_array($country) || $country instanceof \think\Collection || $country instanceof \think\Paginator): if( count($country)==0 ) : echo "" ;else: foreach($country as $key=>$coun): ?>
					<tr>
						<td><?php echo $coun['country']; ?></td>
						<td class="tr"><?php echo $coun['csum']; ?></td>
					</tr>
					<?php endforeach; endif; else: echo "" ;endif; ?>
				</tbody>
			</table>
