<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:95:"/Users/hahah./Documents/wwwroot/hardware-tools/public/../application/Manage/view/admin/role.php";i:1601367001;s:88:"/Users/hahah./Documents/wwwroot/hardware-tools/application/Manage/view/public/header.php";i:1606889687;s:86:"/Users/hahah./Documents/wwwroot/hardware-tools/application/Manage/view/public/left.php";i:1607326502;s:88:"/Users/hahah./Documents/wwwroot/hardware-tools/application/Manage/view/public/footer.php";i:1599103444;}*/ ?>
...
<div class="layui-body" id="LAY_app_body">
    <div class="right">
		...
		<div class="layui-form">
			<a class="layui-btn" href="<?php echo url('role_add'); ?>">添加</a>
			...
			<table class="layui-table">
				...
				<tbody>
					<?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): if( count($list)==0 ) : echo "" ;else: foreach($list as $key=>$v): ?>
						<tr>
							<td class="tc"><?php echo $v['name']; ?>（<?php echo $v['code']; ?>）</td>
							<td class="tc">
							...
							<td class="tc">
								<a href="<?php echo url('role_access', ['id' => $v['id']]); ?>" class="layui-btn layui-btn-sm">配置</a>
								<a href="<?php echo url('role_edit', ['id' => $v['id']]); ?>" class="layui-btn layui-btn-normal layui-btn-sm">编辑</a>
...
layui.use(['form', 'jquery'], function(){
	...
	form.on('submit(Sort)', function(data){
		...
		button.text('请稍候...');
		$.ajax({
			type:'POST',url:"<?php echo url('role_sort'); ?>",data:data.field,dataType:'json',
			success:function(data){
				if(data.code == 1){
	...
	form.on('switch(formLock)', function(data){
		$('button').attr('disabled',true);
		$.ajax({
			type:'POST',url:"<?php echo url('role_status'); ?>",data:{id:data.value,type:'look'},dataType:'json',
			success:function(data){
				if(data.code == 0){
					layer.alert(data.msg,{icon:2,closeBtn:0,title:false,btnAlign:'c'},function(){
						location.reload();
	...
	form.on('submit(Detele)', function(data){
		...
		layer.confirm('确定删除吗？',{icon:3,closeBtn:0,title:false,btnAlign:'c'},function(){
			...
			button.text('请稍候...');
			$.ajax({
				type:'POST',url:"<?php echo url('role_delete'); ?>",data:{id:id},dataType:'json',
				success:function(data){
					if(data.code == 1){
						layer.alert(data.msg,{icon:1,closeBtn:0,title:false,btnAlign:'c'},function(){
							location.reload();
