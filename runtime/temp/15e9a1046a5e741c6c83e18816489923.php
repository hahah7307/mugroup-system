<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:96:"/Users/hahah./Documents/wwwroot/hardware-tools/public/../application/manage/view/visit/index.php";i:1600762707;s:88:"/Users/hahah./Documents/wwwroot/hardware-tools/application/manage/view/public/header.php";i:1606889687;s:86:"/Users/hahah./Documents/wwwroot/hardware-tools/application/manage/view/public/left.php";i:1607326502;s:88:"/Users/hahah./Documents/wwwroot/hardware-tools/application/manage/view/public/footer.php";i:1599103444;}*/ ?>
    ...
    <div class="right">
		...
		<form class="layui-form search-form" method="get">
			<div class="layui-inline w100">
				<input type="text" class="layui-input time" name="start" value="<?php echo $start; ?>" placeholder="开始日期">
			</div>
			<div class="layui-inline w100">
				<input type="text" class="layui-input time" name="end" value="<?php echo $end; ?>" placeholder="结束日期">
			</div>
				...
				<ul class="layui-row layui-col-space10 layui-this">
					...
					<li class="layui-col-xs3">
						<a href="javascript:;" class="layadmin-backlog-body">
							<h3>人均浏览</h3>
							<p>
								<cite><?php echo $data['average']; ?></cite>
					...
					<li class="layui-col-xs3">
						<a href="javascript:;" class="layadmin-backlog-body">
							<h3>IP</h3>
							<p>
								<cite><?php echo $data['clientIp']; ?></cite>
