			...
			<div class="layui-form-item">
				...
				<div class="layui-input-block w300">
					<select name="template_file" lay-verify="required">
						<option value="news" {if condition="$info.template_file eq news"}selected{/if}>默认模板</option>
						<option value="news_event" {if condition="$info.template_file eq news_event"}selected{/if}>大事记模板页（定制）</option>
					</select>
				</div>
			</div>
			<div class="layui-form-item">
