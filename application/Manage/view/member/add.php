    ...
    <div class="right">
		...
		<div class="layui-form">
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline w300">
					<input type="text" class="layui-input" name="company_name">
				</div>
				<label class="layui-form-label">企业性质</label>
				<div class="layui-input-inline w300">
					<input type="text" class="layui-input" name="company_property">
				</div>
			</div>
			<div class="layui-form-item">
				<label class="layui-form-label">企业地址</label>
				<div class="layui-input-inline w720">
					<input type="text" class="layui-input" name="company_address">
				</div>
			</div>
			<div class="layui-form-item">
				<label class="layui-form-label">法人代表</label>
				<div class="layui-input-inline w300">
					<input type="text" class="layui-input" name="legal_name">
				</div>
				<label class="layui-form-label">法人手机</label>
				<div class="layui-input-inline w300">
					<input type="text" class="layui-input" name="legal_tel">
				</div>
			</div>
			<div class="layui-form-item">
				<label class="layui-form-label">法人电话</label>
				<div class="layui-input-inline w300">
					<input type="text" class="layui-input" name="legal_phone">
				</div>
			</div>
			<div class="layui-form-item">
				<label class="layui-form-label">联系人姓名</label>
				<div class="layui-input-inline w300">
					<input type="text" class="layui-input" name="lxr_name">
				</div>
				<label class="layui-form-label">联系人职位</label>
				<div class="layui-input-inline w300">
					<input type="text" class="layui-input" name="lxr_post">
				</div>
			</div>
			<div class="layui-form-item">
				<label class="layui-form-label">联系人手机</label>
				<div class="layui-input-inline w300">
					<input type="text" class="layui-input" name="lxr_tel">
				</div>
				<label class="layui-form-label">联系人电话</label>
				<div class="layui-input-inline w300">
					<input type="text" class="layui-input" name="lxr_phone">
				</div>
			</div>
			<div class="layui-form-item">
				<label class="layui-form-label">网址</label>
				<div class="layui-input-inline w300">
					<input type="text" class="layui-input" name="site_url">
				</div>
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline w300">
					<input type="text" class="layui-input" name="qq_wechat">
				</div>
			</div>
			<div class="layui-form-item">
				<label class="layui-form-label">企业简介</label>
				<div class="layui-input-inline w720">
					<textarea name="company_profile" placeholder="" class="layui-textarea"></textarea>
				</div>
			</div>
			<div class="layui-form-item">
				<label class="layui-form-label">主要产品</label>
				<div class="layui-input-inline w720">
					<textarea name="products" placeholder="" class="layui-textarea"></textarea>
				</div>
			</div>
			<div class="layui-form-item">
				<label class="layui-form-label">通过认证</label>
				<div class="layui-input-inline w720">
					<textarea name="certification" placeholder="" class="layui-textarea"></textarea>
				</div>
			</div>
			<div class="layui-form-item">
