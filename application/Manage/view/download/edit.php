		...
		<div class="layui-form">
			<div class="layui-form-item">
				...
				<div class="layui-input-inline w800">
					...
					<span id="upload-url">{$info.url}</span>
				</div>
			</div>
			<div class="layui-form-item">
				<label class="layui-form-label">类型</label>
				<div class="layui-input-inline w300">
					<input type="text" class="layui-input" name="suffix" id="suffix" value="{$info.suffix}">
				</div>
			</div>
			<div class="layui-form-item">
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline w800">
					<textarea name="short" placeholder="" class="layui-textarea">{$info.short}</textarea>
				</div>
			</div>
			<div class="layui-form-item">
