    ...
    <div class="right">
		...
		<div class="layui-form">
			<div class="layui-form-item">
				...
				<div class="layui-input-inline w300">
					...
					<span class="input-group-btn">
						...
						{if condition="$info.thumb neq null"}
							<li style="margin: 2px">
								<img src="/upload/{$info.thumb}">
								<span>
				...
				<div class="layui-input-block w300">
					<select name="cid" lay-verify="required">
						{foreach name="category" item="v"}
							<option value="{$v.id}" {if condition="$v.id eq $info['cid']"}selected{/if}>{$v.name}</option>
						{/foreach}
					</select>
				</div>
			</div>
			<div class="layui-form-item">
				...
				<div class="layui-input-inline w300">
					<input type="text" class="layui-input" name="author" value="{$info.author}">
				</div>
			</div>
			<div class="layui-form-item">
				<label class="layui-form-label">概要</label>
				<div class="layui-input-inline w800">
					<textarea name="summary" placeholder="" class="layui-textarea">{$info.summary}</textarea>
				</div>
			</div>
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline tiny-mce-text w800">
					<textarea id="mytextarea" name="content">{$info.content}</textarea>
				</div>
			</div>
			<div class="layui-form-item">
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline w300">
					<input type="text" class="layui-input time" name="created_at" value="{:date('Y-m-d H:i:s',$info['created_at'])}" placeholder="发布日期">
				</div>
			</div>
			<div class="layui-form-item">
				<label class="layui-form-label">首页显示</label>
				<div class="layui-input-block">
					<input type="radio" name="show_home" value="1" title="是" {if condition="$info['show_home'] eq 1"}checked{/if}>
					<input type="radio" name="show_home" value="0" title="否" {if condition="$info['show_home'] eq 0"}checked{/if}>
				</div>
			</div>
			<div class="layui-form-item">
